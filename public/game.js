(() => {
  ...
  */
  ...
  function update() {
    ...
    // ÐÑÐ»Ð¸ Ð¼Ð¾Ð½ÑÑÑÐ¸Ðº ÑÐµÐ°Ð»ÑÐ½Ð¾ ÑÑÑÐ» Ð½Ð¸Ð¶Ðµ ÑÐºÑÐ°Ð½Ð°, Ð¸Ð³ÑÐ° Ð·Ð°ÐºÐ°Ð½ÑÐ¸Ð²Ð°ÐµÑÑÑ.
    // ÐÑÐ¾Ð²ÐµÑÐºÐ° ÑÑÐ¾Ð¸Ñ Ð´Ð¾ ÐºÐ¾Ð»Ð»Ð¸Ð·Ð¸Ð¹, ÑÑÐ¾Ð±Ñ Ð¾Ð½ Ð½Ðµ Ð¾ÑÑÐºÐ°ÐºÐ¸Ð²Ð°Ð» Ð¾Ñ Ð½Ð¸Ð¶Ð½ÐµÐ¹ ÑÐºÑÑÑÐ¾Ð¹ Ð¿Ð»Ð°ÑÑÐ¾ÑÐ¼Ñ.
    ...
    if (player.vy > 0) {
      for (const p of platforms) {
        ...
        // Ð¡ÑÐ°ÑÑÐ¾Ð²Ð°Ñ Ð½Ð¸Ð¶Ð½ÑÑ Ð¿Ð»Ð°ÑÑÐ¾ÑÐ¼Ð° Ð½ÑÐ¶Ð½Ð° ÑÐ¾Ð»ÑÐºÐ¾ Ð² ÑÐ°Ð¼Ð¾Ð¼ Ð½Ð°ÑÐ°Ð»Ðµ.
        if (p.start && score > 0) continue;

        // ÐÐ»Ð°ÑÑÐ¾ÑÐ¼Ñ, ÑÑÐµÐ´ÑÐ¸Ðµ Ð² ÑÑÐ°Ð²Ñ/Ð½Ð¸Ð· ÑÐºÑÐ°Ð½Ð°, Ð±Ð¾Ð»ÑÑÐµ Ð½Ðµ Ð°ÐºÑÐ¸Ð²Ð½Ñ.
